...
\begin{minipage}{\textwidth}
  \begin{parcolumns}{2}
    \colchunk{\begin{lstlisting}[caption=PCA,language=Python]{Name}
        preprocess_pca = [ 
          ("pre-standardize", StandardScaler()),
          ("PCA", PCA(n_components = 0.95)),
          ("standardize",StandardScaler()),
    ...
    \colchunk{\begin{lstlisting}[caption=ANOVA,language=Python]{Name}
        preprocess_anova = [
          ("pre-standardize", StandardScaler()),
...
\begin{minipage}{\textwidth}
  \begin{parcolumns}{3}
    \colchunk{\begin{lstlisting}[caption=Estandarizacion]{Name}
        ----- Mejor clasificador lineal encontrado ------
        - Parametros:
        SVC(C=0.1, kernel='linear', max_iter=10000, tol=0.0001)
        - Accuracy en Cross Validation
        0.9270076172098257
    \end{lstlisting}}
    ...
    \colchunk{\begin{lstlisting}[caption=PCA]{Name}
        ----- Mejor clasificador lineal encontrado ------
        - Parametros:
        SVC(C=1, kernel='linear', max_iter=10000, tol=0.0001)
        - Accuracy en Cross Validation
        0.9175952226837361
    \end{lstlisting}}

    \colchunk{\begin{lstlisting}[caption=ANOVA]{Name}
        ----- Mejor clasificador lineal encontrado ------
        - Parametros:
        SVC(C=0.1, kernel='linear', max_iter=10000, tol=0.0001)
        - Accuracy en Cross Validation
