...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.7]{media/f_evolution_e1-1.pdf}
...
$$
\frac{\partial MSE(w)}\frac{\partial w_j} = \frac{2}{N} = \sum_{i = 1 }^N  x_{ij}(X_i w_i - y_i).
$$
...
Hemos presentado los algoritmos que utilizaremos y la función de error. Podemos pasar a la realización de los diferentes experimentos.
